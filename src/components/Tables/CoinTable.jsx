              ...
              .map((row, index) => {
                return (
                  <TableRow hover role="checkbox" tabIndex={-1} key={row.id} >
                    ...
                    <button type="button" className="btn  btn-outline-warning shadow-none" data-bs-toggle="modal" data-bs-target={`#exampleModalmmm${index}`}>
                      <BorderColorIcon />
                    </button>

                    {/* <!-- Modal --> */}
                    <div className="modal fade" id={`exampleModalmmm${index}`} tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
